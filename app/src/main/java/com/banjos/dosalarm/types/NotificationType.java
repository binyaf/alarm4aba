...
public enum NotificationType {
    ...
    CANDLE_LIGHTING_REMINDER("CANDLE_LIGHTING_REMINDER", 1),
    STOP_CANDLE_LIGHTING_REMINDER("STOP_CANDLE_LIGHTING_REMINDER", 1),
    SNOOZE_CANDLE_LIGHTING_REMINDER("SNOOZE_CANDLE_LIGHTING_REMINDER", 1),
